...
const golobalErrorhandler = (err, req, res, next) => {
    let statusCode = 500;
    ...
    return res.status(statusCode).json({
        ...
        stack: config_1.default.NODE_ENV === 'deveopment' ? err === null || err === void 0 ? void 0 : err.stack : null,
    });
};
exports.default = golobalErrorhandler;
